                  ...
                  <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">
                        {(patient.dynamicData?.["First Name"] || patient.firstName) + " " + (patient.dynamicData?.["Last Name"] || patient.lastName)}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Date of Birth</dt>
                      <dd className="mt-1 text-sm text-gray-900">
                        {patient.dynamicData?.["Date of Birth"]
                          ? new Date(patient.dynamicData["Date of Birth"]).toLocaleDateString()
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900 capitalize">
                        {patient.dynamicData?.["Gender"] || patient.gender}
                      </dd>
                    </div>
                    <div>
                ...
                <div className="px-6 py-4">
                  <dl className="grid grid-cols-1 gap-y-6">
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">
                        {patient.dynamicData?.["Email"] || patient.email}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Phone</dt>
                      <dd className="mt-1 text-sm text-gray-900">
                        {patient.dynamicData?.["phone"] || patient.dynamicData?.["Phone"] || patient.phone}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Address</dt>
                      <dd className="mt-1 text-sm text-gray-900">
                        {patient.dynamicData?.["address"]?.street || patient.address?.street} | <br />
                        {patient.dynamicData?.["address"]?.city || `, ${patient.dynamicData["Apt/Unit #"]}`}
                        <br />
                        {(patient.dynamicData?.["address"]?.country || patient.address?.city) +
                          (patient.dynamicData?.["State"] ? `, ${patient.dynamicData["State"]}` : patient.address?.state ? `, ${patient.address.state}` : "") +
                          (patient.dynamicData?.["Zip Code"] ? ` ${patient.dynamicData["Zip Code"]}` : patient.address?.zipCode ? ` ${patient.address.zipCode}` : "")}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Preferred Contact Method</dt>
                      <dd className="mt-1 text-sm text-gray-900">
                        {patient.dynamicData?.["Preferred contact method"] || "-"}
                      </dd>
                    </div>
                  </dl>
                </div>
