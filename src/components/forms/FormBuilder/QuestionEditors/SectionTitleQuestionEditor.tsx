...
const SectionTitleQuestionEditor: React.FC<SectionTitleQuestionProps> = ({ item, onChange }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-teal-500">
      ...
      <div className="mb-6">
        <label htmlFor="sectionTitle" className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
      ...
      <div className="mb-6">
        ...
        <div className="border border-gray-200 rounded-md p-4 bg-gray-50 hover:shadow-md transition-all duration-200">
          <h3 className="text-lg font-medium text-teal-900 mb-2 border-b border-teal-200 pb-2">{item.sectionTitle || 'Section Title'}</h3>
          <p className="text-sm text-gray-600">{item.content || 'Section content or instructions'}</p>
        </div>
      </div>
    </div>
  );
